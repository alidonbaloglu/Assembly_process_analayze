...
def main():
    ...
    YOLO_MODEL_PATH = "Modeller/montaj_s_batuhan.pt"  # YOLO model dosyasının yolu
    VIDEO_PATH = "C:/Users/ali.donbaloglu/Desktop/Montaj_proces/input_video/part14.mp4"   # Video dosyasının yolu
