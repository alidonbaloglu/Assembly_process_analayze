    ...
    def process_video(self, video_path: str, output_path: str = None, display: bool = True, mask_path: Optional[str] = None) -> List[Dict]:
        ...
        try:
            while True:
                ...
                current_group = self.get_current_group()
                if current_group:
                    group_text = f"{current_group['name']} [{len(self.current_group_completed_tasks)}/{len(current_group['tasks'])}]"
                    cv2.putText(display_frame, group_text, (10, 30),
                              cv2.FONT_HERSHEY_SIMPLEX, 0.7, (255, 255, 255), 2)
                
                # Görev bilgisi
                task_text = f"Task: {self.n} - {self.current_task_name or 'No Task'}"
                cv2.putText(display_frame, task_text, (10, 70),
                          cv2.FONT_HERSHEY_SIMPLEX, 1, (255, 255, 0), 2)
                
                # FPS ve frame
                cv2.putText(display_frame, f"FPS: {fps_smooth:.1f}", (10, 110),
...
def main():
    ...
    YOLO_MODEL_PATH = "C:/Users/ali.donbaloglu/Desktop/Montaj_proces/Modeller/Tez/yolov8m_20260115_181828/weights/best.pt"  # YOLO model dosyasının yolu
    VIDEO_PATH = "C:/Users/ali.donbaloglu/Desktop/Montaj_proces/input_video/Part22_yeni.mp4"   # Video dosyasının yolu
    OUTPUT_VIDEO_PATH = "C:\\Users\\ali.donbaloglu\\Desktop\\Montaj_proces\\output_video\\yeni_sonuclar\\Part22_output_video.mp4"  # Çıkış video dosyası (opsiyonel)
    RESULTS_JSON_PATH = "C:\\Users\\ali.donbaloglu\\Desktop\\Montaj_proces\\output_video\\yeni_sonuclar\\Part22_tspd_results.json"  # Sonuçlar JSON dosyası
    MASK_PATH = "C:/Users/ali.donbaloglu/Desktop/Montaj_proces/mask_yeni.png"  # Maske dosyasının yolu (opsiyonel - None olabilir)
